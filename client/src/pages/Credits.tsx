...
function Section({ title, icon, children }: { title: string; icon: React.ReactNode; children: React.ReactNode }) {
  return (
    <div className="rounded-xl border p-6 mb-4" style={{ borderColor: "oklch(0.90 0.006 162)", background: "white" }}>
      <div className="flex items-center gap-2 mb-4">
        <span style={{ color: "oklch(0.32 0.10 162)" }}>{icon}</span>
        <h2 className="text-base font-bold" style={{ fontFamily: "Sora, sans-serif", color: "oklch(0.18 0.015 65)" }}>
          {title}
        </h2>
      </div>
      {children}
...
function CreditRow({ name, role, url, note }: { name: string; role: string; url?: string; note?: string }) {
  return (
    <div className="flex items-start justify-between py-2 border-b last:border-0" style={{ borderColor: "oklch(0.93 0.004 162)" }}>
      <div>
        <div className="text-sm font-semibold" style={{ fontFamily: "Sora, sans-serif", color: "oklch(0.22 0.015 65)" }}>{name}</div>
        <div className="text-xs" style={{ color: "oklch(0.55 0.015 65)", fontFamily: "Nunito Sans, sans-serif" }}>{role}</div>
    ...
    <div className="min-h-screen" style={{ background: "oklch(0.98 0.003 90)" }}>
      ...
      <div className="max-w-3xl mx-auto px-6 md:px-10 py-6">
        ...
        <div className="rounded-xl border-2 p-5 mb-6 flex gap-4" style={{ borderColor: "oklch(0.80 0.12 30)", background: "oklch(0.97 0.04 30)" }}>
          ...
          <div>
            <h2 className="font-bold text-sm mb-2" style={{ fontFamily: "Sora, sans-serif", color: "oklch(0.35 0.18 30)" }}>
              Important Medical Disclaimer
            </h2>
            <p className="text-xs leading-relaxed" style={{ color: "oklch(0.40 0.12 30)", fontFamily: "Nunito Sans, sans-serif" }}>
            ...
            <p className="text-xs leading-relaxed mt-2" style={{ color: "oklch(0.40 0.12 30)", fontFamily: "Nunito Sans, sans-serif" }}>
        ...
        <Section title="Primary Data Sources" icon={<Database size={18} />}>
          <p className="text-xs mb-4" style={{ color: "oklch(0.50 0.015 65)", fontFamily: "Nunito Sans, sans-serif" }}>
        ...
        <Section title="Acknowledgements" icon={<Heart size={18} />}>
          <p className="text-xs leading-relaxed" style={{ color: "oklch(0.45 0.015 65)", fontFamily: "Nunito Sans, sans-serif" }}>
          ...
          <p className="text-xs leading-relaxed mt-3" style={{ color: "oklch(0.45 0.015 65)", fontFamily: "Nunito Sans, sans-serif" }}>
        ...
        <div className="text-center py-4">
          ...
          <p className="text-xs mt-1" style={{ color: "oklch(0.70 0.015 65)" }}>
            ...
            <a href="mailto:feedback@fooddb.sg" className="underline" style={{ color: "oklch(0.32 0.10 162)" }}>contact us</a>.
          </p>
        </div>
